    ...
    <div>
      ...
      <label
        ...
        className="flex items-center justify-center cursor-pointer w-8 h-8
                   hover:bg-gray-200 lg:hover:bg-gray-300
                   dark:hover:bg-gray-700/50 dark:lg:hover:bg-gray-800
                   rounded-full transition-colors"
      >
        {/* Moon icon: hanya tampil di light mode */}
        <svg
          className="block dark:hidden fill-current text-gray-500 transition-colors"
          width={16}
          height={16}
          viewBox="0 0 16 16"
        ...
        {/* Sun icon: hanya tampil di dark mode */}
        <svg
          className="hidden dark:block fill-current text-gray-400 transition-colors"
          width={16}
          height={16}
          viewBox="0 0 16 16"
          xmlns="http://www.w3.org/2000/svg"
