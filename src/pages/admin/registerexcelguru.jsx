...
const RegisterExcelTeacher = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const response = await axios.post('https://api-uks.rplrus.com/api/gurus/import-excel', formData, {
        headers: {
      ...
      if (response.data.status === 'success') {
        ...
        showToastMessage('Import guru berhasil diselesaikan!', 'success');
      } else {
      ...
      const errorMessage =
        err.response?.status === 401
          ...
          : err.response?.data?.message || 'Gagal mengimport guru. Silakan coba lagi.';
              ...
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300 mt-1">
                    Unggah file Excel untuk menambah guru secara massal
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden mb-8">
              <div className="bg-gradient-to-r from-teal-50 to-blue-50 dark:from-gray-700 dark:to-gray-600 px-8 py-6 border-b border-gray-200 dark:border-gray-600">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">
                  Pilih file .xlsx yang berisi data guru untuk diimport
                </p>
              </div>
                    ...
                    {importResult.created.length > 0 && (
                      <div className="bg-green-50 dark:bg-green-900/20 p-6 rounded-xl border border-green-200 dark:border-green-800">
                        <h4 className="font-semibold text-green-800 dark:text-green-300 mb-4 flex items-center gap-2">
                          ...
                          Guru yang Berhasil Dibuat ({importResult.created.length})
                        </h4>
                    ...
                    {importResult.failed.length > 0 && (
                      <div className="bg-red-50 dark:bg-red-900/20 p-6 rounded-xl border border-red-200 dark:border-red-800">
                        <h4 className="font-semibold text-red-800 dark:text-red-300 mb-4 flex items-center gap-2">
                          ...
                          Guru yang Gagal Diimport ({importResult.failed.length})
                        </h4>
                        <div className="max-h-48 overflow-y-auto">
                          <div className="space-y-2">
...
export default RegisterExcelTeacher;