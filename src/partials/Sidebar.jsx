                  ...
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                        className={`block text-gray-800 dark:text-gray-100 truncate transition duration-150 ${
                          pathname.includes("Edukasi Kesehatan")
                            ? ""
                            : "hover:text-gray-900 dark:hover:text-white"
                        }`}
                        onClick={(e) => {
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        ...
                        >
                          ...
                          <li className="mb-1 last:mb-0">
                            <a
                              href="/register"
                              className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200 hover:text-gray-700 dark:hover:text-gray-200 transition truncate"
                            >
                              Sign up
                            </a>
                          </li>
